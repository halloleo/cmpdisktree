...
class ErrorKind(Enum):
    ...
    NOT_EXIST_IN_2 = 'PATH does not exist in FS2' # In txt() the word PATH might be replaced file kind
    DIFF = 'PATH is different'
    MISMATCH = 'Node type in FS2 is not PATH'
    NOACCESS = 'No access to PATH (e.g. file permissions)' # In txt() the word PATH might be replaced file kind
