"""
invoke Tasks for maintaining the cmpdisktree project
"""
import platform
import shutil
...
def format(c, check=False):
    ...
    c.run(f'pipenv run black {black_opts} {python_dirs_string}')
...
@task(help={'part': "Specify version number part [major|minor|patch] (default: 'patch')"})
